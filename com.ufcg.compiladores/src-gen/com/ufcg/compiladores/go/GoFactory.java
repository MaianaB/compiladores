...
public interface GoFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Souce File</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Souce File</em>'.
   * @generated
   */
  SouceFile createSouceFile();
  ...
  /**
   * Returns a new object of class '<em>top Level Decl Linha</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>top Level Decl Linha</em>'.
   * @generated
   */
  topLevelDeclLinha createtopLevelDeclLinha();
   ...
   * @generated
   */
  switch_stmt_linha createswitch_stmt_linha();
