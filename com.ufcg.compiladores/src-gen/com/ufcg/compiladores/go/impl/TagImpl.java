 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiladores.go.impl.TagImpl#getString_lit <em>String lit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagImpl extends MinimalEObjectImpl.Container implements Tag
{
  ...
  public NotificationChain basicSetString_lit(string_lit newString_lit, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoPackage.TAG__STRING_LIT, oldString_lit, newString_lit);
  ...
  public void setString_lit(string_lit newString_lit)
  {
    if (newString_lit != string_lit)
    {
      ...
      if (string_lit != null)
        msgs = ((InternalEObject)string_lit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoPackage.TAG__STRING_LIT, null, msgs);
      if (newString_lit != null)
        msgs = ((InternalEObject)newString_lit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoPackage.TAG__STRING_LIT, null, msgs);
      msgs = basicSetString_lit(newString_lit, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoPackage.TAG__STRING_LIT, newString_lit, newString_lit));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GoPackage.TAG__STRING_LIT:
