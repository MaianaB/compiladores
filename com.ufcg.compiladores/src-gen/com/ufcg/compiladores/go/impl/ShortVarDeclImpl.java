 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiladores.go.impl.ShortVarDeclImpl#getIdentifierList <em>Identifier List</em>}</li>
 *   <li>{@link com.ufcg.compiladores.go.impl.ShortVarDeclImpl#getExpressionList <em>Expression List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShortVarDeclImpl extends MinimalEObjectImpl.Container implements ShortVarDecl
{
  ...
  public NotificationChain basicSetIdentifierList(IdentifierList newIdentifierList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoPackage.SHORT_VAR_DECL__IDENTIFIER_LIST, oldIdentifierList, newIdentifierList);
  ...
  public void setIdentifierList(IdentifierList newIdentifierList)
  {
    if (newIdentifierList != identifierList)
    {
      ...
      if (identifierList != null)
        msgs = ((InternalEObject)identifierList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoPackage.SHORT_VAR_DECL__IDENTIFIER_LIST, null, msgs);
      if (newIdentifierList != null)
        msgs = ((InternalEObject)newIdentifierList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoPackage.SHORT_VAR_DECL__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifierList(newIdentifierList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoPackage.SHORT_VAR_DECL__IDENTIFIER_LIST, newIdentifierList, newIdentifierList));
  }
