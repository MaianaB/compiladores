 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiladores.go.impl.VarSpecImpl#getIdentifierList <em>Identifier List</em>}</li>
 *   <li>{@link com.ufcg.compiladores.go.impl.VarSpecImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.ufcg.compiladores.go.impl.VarSpecImpl#getExpressionList <em>Expression List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarSpecImpl extends MinimalEObjectImpl.Container implements VarSpec
{
  ...
  public NotificationChain basicSetIdentifierList(IdentifierList newIdentifierList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoPackage.VAR_SPEC__IDENTIFIER_LIST, oldIdentifierList, newIdentifierList);
  ...
  public void setIdentifierList(IdentifierList newIdentifierList)
  {
    if (newIdentifierList != identifierList)
    {
      ...
      if (identifierList != null)
        msgs = ((InternalEObject)identifierList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoPackage.VAR_SPEC__IDENTIFIER_LIST, null, msgs);
      if (newIdentifierList != null)
        msgs = ((InternalEObject)newIdentifierList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoPackage.VAR_SPEC__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifierList(newIdentifierList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoPackage.VAR_SPEC__IDENTIFIER_LIST, newIdentifierList, newIdentifierList));
  }
